...
export default function sketch(p) {
    ...
    class Car {
        ...
        is_on_platform(platform) {
            ...
            var is_stable_y =
                adj_height >= platform.y &&
                adj_height <= platform.y + this.forceY;
            var is_stable_x =
                this.x < platform.x + platform.size && adj_width > platform.x;
        ...
        at_canvas_boundary() {
            ...
            return (
                adj_height >= p.height && adj_height <= p.height + this.forceY
            );
        }
